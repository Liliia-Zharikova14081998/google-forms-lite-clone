import { api, TypedDocumentString } from './baseApi';
...
export type GetFormQuery = { __typename?: 'Query', form?: { __typename?: 'Form', id: string, title: string, description?: string | null, questions?: Array<{ __typename?: 'Question', id: string, text: string, type: QuestionType, options?: Array<string | null> | null } | null> | null } | null };
...
export type GetResponsesQuery = { __typename?: 'Query', responses: Array<{ __typename?: 'Response', id: string, formId: string, answers?: Array<{ __typename?: 'Answer', questionId: string, value: string } | null> | null }> };
